...
export const DialogContent = ({
  ...
  return (
    <ShadcnDialogContent
      className={`p-0 flex flex-col max-h-[90vh] ${className || ""}`}
      {...props}
    >
      {children}
    </ShadcnDialogContent>
...
export const DialogHeader = ({
  ...
  return (
    <ShadcnDialogHeader
      className={`px-6 pt-6 pb-4 flex-shrink-0 ${className || ""}`}
      {...props}
    >
      {children}
    </ShadcnDialogHeader>
...
export const DialogBody = ({
  ...
  return (
    <div
      className={`flex-1 overflow-y-auto px-6 py-2 min-h-0 ${className || ""}`}
      {...props}
    >
      {children}
    </div>
...
export const DialogFooter = ({
  ...
  return (
    <ShadcnDialogFooter
      className={`px-6 pb-6 pt-4 flex-shrink-0 ${className || ""}`}
      {...props}
    >
      {children}
    </ShadcnDialogFooter>
